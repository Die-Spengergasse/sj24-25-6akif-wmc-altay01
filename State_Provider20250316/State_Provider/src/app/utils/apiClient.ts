...
// Added a new function to handle success responses
export function createSuccessResponse<T>(response: any): { data: T, status: number } {
    return {
        data: response.data,
        status: response.status
    }
...
// Added a new function to handle responses
export function handleResponse<T>(response: any): { data: T, status: number } | ErrorResponse {
